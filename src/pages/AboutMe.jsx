      ...
      >
        ...
        <div className="flex flex-col lg:flex-row lg:flex-center lg:gap-[5rem]">
          ...
          <div className="text-grey-light regular-text-mobile px-[58px] leading-[162%] lg:leading-[178%] lg:regular-text lg:w-[920px]">
            ...
            continuous learning and tackling new challenges that help me grow
            both personally and professionally. I am a responsible and dedicated
            individual, always eager to take on opportunities that push my
            skills further. I look forward to contributing my abilities and
            positive attitude to the success of the team and the organization.
          </div>
        </div>
      </div>
    </>
